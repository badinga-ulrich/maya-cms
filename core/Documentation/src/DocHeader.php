...
class DocHeader
{
    ...
    public function render($path="") : string
    {
        ...
        ?>
            <li>
                <a href="<?php echo $path ?>#<?php echo $this->getAnchor() ?>"><?php echo $this->title ?></a>
                <?php echo $this->renderSubheaders($path) ?>
            </li>
        <?php
    ...
    private function renderSubheaders($path="") : string
    {
