...
class Admin extends \Maya\AuthController {
    ...
    public function index() {
        ...
        foreach ($_singletons as $name => $meta) {
            ...
            $meta['allowed'] = [
                'delete' => $this->module('maya')->hasaccess('singletons', 'delete'),
                'create' => $this->module('maya')->hasaccess('singletons', 'create'),
    ...
    public function singleton($name = null) {
        ...
        if (!$name && !$this->module('maya')->hasaccess('singletons', 'create')) {
            return $this->helper('admin')->denyRequest();
        }
