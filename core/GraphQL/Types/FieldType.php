    ...
    protected static function getType($field) {
        ...
        switch ($field['type']) {
            ...
            case 'collectionlinkselect':
                ...
                $collection = maya('collections')->collection($field['options']['link']);
                ...
                if (isset($field['options']['multiple']) && $field['options']['multiple']) {
                    ...
                    $def['resolve'] = function ($root, $args) use ($field) {
                        ...
                        return maya('collections')->find($field['options']['link'], $options);
                    };
                } else {
                    ...
                    $def['resolve'] = function ($root, $args, $context, $info) use ($field) {
                        ...
                        return maya('collections')->findOne($field['options']['link'], [
            ...
            default:
                maya()->trigger("graphql.type.{$field['type']}", [$field, &$def]);
        }
