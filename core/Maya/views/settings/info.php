...
<div riot-view>
    ...
    <div class="uk-grid" data-uk-grid-margin>
        ...
        <div class="uk-width-medium-3-4">
            ...
            <div id="settings-info" class="uk-switcher">
                ...
                <div>
                    ...
                    @if($app->module('maya')->isSuperAdmin() && count(getenv()))
            ...
            @trigger("maya.settings.infopage.main")
        ...
        <div class="uk-width-medium-1-4">
            ...
            @trigger("maya.settings.infopage.aside")
        </div>
        ...
        <script type="view/script">
            ...
            cleanUpCache() {
                ...
                App.callmodule('maya:clearCache').then(function(){
                    setTimeout(function(){
                        $this.cleaning = false;
                        $this.cacheSize = 0;
                        $this.update();
