...
<head>
    ...
    {{ $app->assets($app['app.assets.base'], $app['debug'] ? time() : $app['maya/version']) }}
    {{ $app->assets(['assets:lib/uikit/js/components/form-password.min.js'], $app['debug'] ? time() : $app['maya/version']) }}
