...
<div class="uk-grid uk-margin-top uk-invisible" data-uk-grid-margin riot-view>
                ...
                <div class="uk-width-medium-1-1">
                    ...
                    <form id="account-form" class="uk-form" onsubmit="{ submit }">
                        ...
                        <div class="uk-grid-margin" show="{tab == 'general'}">
                            ...
                            @trigger('maya.account.panel', [&$account])
                        ...
                        @trigger('maya.account.editview', [&$account])

                        <cp-actionbar>
                            <div class="uk-container uk-container-center">
                                <button class="uk-button uk-button-large uk-button-primary">@lang('Save')</button>
                                <a class="uk-button uk-button-large uk-button-link" href="@route($app->module('maya')->hasaccess('maya', 'accounts') ? '/accounts' : '/')">@lang('Cancel')
                                </a>
                            </div>
                        </cp-actionbar>
    ...
    <div class="uk-width-medium-1-4 uk-form">
        ...
        @if($app->module('maya')->isSuperAdmin() && @$account["_id"] != $app["user"]["_id"])
        <div class="uk-form-row">
    ...
    <script type="view/script">
        ...
        this.on('mount', function(){
            ...
            var idle = setInterval(function() {
                ...
                Maya.lockResource($this.account._id, function(e){
