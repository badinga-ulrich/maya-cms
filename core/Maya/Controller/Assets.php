...
class Assets extends \Maya\AuthController {

    public function index() {

        return $this->render('maya:views/assets/index.php');
    }
    ...
    public function listAssets() {
        ...
        $ret = $this->module('maya')->listAssets($options);
        ...
        $this->app->trigger('maya.assetsfolders.find.before', [&$options]);
        $ret['folders'] = $this->app->storage->find('maya/assets_folders', $options)->toArray();
    ...
    public function asset($id) {
        ...
        return $this->app->storage->findOne('maya/assets', ['_id' => $id]);
    }
    ...
    public function upload() {
        ...
        return $this->module('maya')->uploadAssets('files', $meta);
    }
    ...
    public function uploadfolder() {
        ...
        $mkdir = function($path) use($root, $cache, $user) {
            ...
            while ($i < count($folders)) {
                ...
                if (!isset($cache[$_cpath])) {
                    ...
                    $exists = $this->app->storage->findOne('maya/assets_folders', [
                        '_p' => $parentId,
                    ...
                    if ($exists) {
                        ...
                        $this->app->storage->save('maya/assets_folders', $f);
                        $cache[$_cpath] = $f['_id'];
                    }
        ...
        foreach ($folders as $path => $_files) {
            ...
            $ret = \array_merge_recursive($ret, $this->module('maya')->uploadAssets($_files, $meta));
        }
    ...
    public function addFolder() {
        ...
        $this->app->storage->save('maya/assets_folders', $folder);
    ...
    public function removeFolder() {
        ...
        while ($f = $this->app->storage->findOne('maya/assets_folders', ['_p' => $f['_id']])) {
            $ids[] = $f['_id'];
        }

        $this->app->storage->remove('maya/assets_folders', ['_id' => ['$in' => $ids]]);
    ...
    public function _folders() {
        ...
        $_folders = $this->app->storage->find('maya/assets_folders', $options)->toArray();
    ...
    public function updateAssetFile() {
        ...
        return $this->module('maya')->updateAssetFile('file', $asset);
    }
